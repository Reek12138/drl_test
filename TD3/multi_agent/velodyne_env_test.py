...
class GazeboEnv:
    ...
    def __init__(self, launchfile, environment_dim, agent_name):
        ...
        self.set_self_state.model_name = self.agent_name
        ...
        self.vel_pub = rospy.Publisher(f"/{self.agent_name}/cmd_vel", Twist, queue_size=1)
        ...
        self.velodyne = rospy.Subscriber(
            f"/{self.agent_name}/velodyne_points", PointCloud2, self.velodyne_callback, queue_size=1
        )
        self.odom = rospy.Subscriber(
            f"/{self.agent_name}/odom", Odometry, self.odom_callback, queue_size=1
